...
## Niveau 10 -> 11
But: base de l'encodage et du décodage en base64

Méthode: utiliser la commande `base64` pour retrouver le mot de passe.

Solution: `base64 -d data.txt`, (`-d`) pour décoder

Appris: commande `base64``
